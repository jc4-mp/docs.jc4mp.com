...
**Parameters:**
- `part: VehiclePart` - The [part](/shared-api/vehiclepart) to get the state of

**Returns:** [VehiclePartState](/shared-api/vehiclepartstate) - The state of the vehicle part