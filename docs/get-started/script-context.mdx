...
If you want to share static data and functionality between scripts (eg. in the example above), you can use **[Modules](/shared-api/modules)**. If you want to share dynamic data between scripts at runtime, such as telling a script to add one to a counter when a user does an action, you can use **[Events](/shared-api/events)**.