...
Adding scripts to your server is the primary way to customize and extend gameplay. This guide will walk you through everything you need to know as a beginner.
...
- **`.html`, `.css`, `.js`** - For creating [webviews](/client-api/webview) (UI elements)
