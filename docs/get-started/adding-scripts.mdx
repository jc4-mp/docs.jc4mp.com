...
If you're just getting started, consider downloading the [official default scripts](/tools/servers#default-scripts)! They include essential features like chat commands and player management, and serve as great examples for learning how scripts work. See the [Server Setup](/get-started/server-setup#step-8-download-and-add-default-scripts) guide for installation instructions.
:::
