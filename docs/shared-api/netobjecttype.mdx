...
The `NetObjectType` enum represents different types of network objects in the game. This is used with the [`NetObjectBase:GetType()`](/shared-api/netobjectbase) method to determine the type of a network object.
...
- [`NetObjectBase:GetType()`](/shared-api/netobjectbase) - Returns the type of the network object
- [`NetObjectBase:AsPlayer()`](/shared-api/netobjectbase) - Casts to NetPlayer if the object is a player
- [`NetObjectBase:AsVehicle()`](/shared-api/netobjectbase) - Casts to NetVehicle if the object is a vehicle 