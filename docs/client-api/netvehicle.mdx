...
Controls whether a specific vehicle light is enabled or disabled. This function MUST be used inside the [OnVehicleRender](/client-api/events#OnVehicleRender) event.
...
**Returns:** [AABB](/shared-api/aabb) - The local AABB of the vehicle. This is a table containing two fields: `min` and `max`, both of which are vec3
...
**Returns:** [VehicleType](/shared-api/vehicletype) - The type of the vehicle
