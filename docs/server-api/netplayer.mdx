...
This is the server-side class for [NetPlayer](/shared-api/netplayer). Inherits from [NetObject_Server](/server-api/netobject). It has all the same methods and properties as the shared class, plus the following on this page.
...
Warps the player into a [vehicle](/shared-api/netvehicle) at a specific [seat](/shared-api/vehicleseat).
