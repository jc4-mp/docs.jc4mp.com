...
:::info Important Note
JC4MP servers do **not** allow you to play the original story mode in coop with friends. Instead, these servers enable you to build unique and original gamemodes and experiences! Create your own custom gameplay, design unique challenges, or build entirely new multiplayer experiences from scratch.
:::
...
- **🤖 Chat with Rico** - Need help writing scripts? Visit our [Chat with Rico](/chat) page to learn how to make scripts or even have our AI assistant write scripts for you!
...
Let's get started! Head over to our [Server Setup Guide](/get-started/server-setup) and you'll have your server running in no time. Need help with scripting? Check out our [Chat with Rico](/chat) page - an AI assistant that can help you create scripts for your JC4MP server. The adventure awaits!
