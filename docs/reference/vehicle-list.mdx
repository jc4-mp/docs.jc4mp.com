...
| Chevalier Ice Breaker <br/>`v084_car_icecreamtruck_garage` | vehicle,land,buggy,garage |
| Tuk Tuk Boom Boom <br/>`v085_car_explosivetrike_garage` | vehicle,land,trike,garage |
...
| Rubber ducky <br/>`v117_boat_duck_garage` | vehicle,sea,boat,ship,garage,ocean |
...
| Name | Tags |
| ---- | ----------- |
| Dropzone chopper (BH) <br/>`v202_helicopter_heavytroop_gabriela` | vehicle,air,mission |
| Dropzone chopper (AOC) <br/>`v202_helicopter_heavytroop_mira` | vehicle,air,mission |
...
## Preorder DLC Vehicles

These vehicles were included as a pre-order bonus and are now available for purchase separately or included in the Just Cause 4 Reloaded bundle.

### [Deathstalker Scorpion pack](https://store.steampowered.com/app/868420/Just_Cause_4_Deathstalker_Scorpion_Pack/)

| Name | Tags |
| ---- | ----------- |
| Deathstalker Scorpion assault buggy <br/>`v046_car_racingbuggy_preorder_01` | vehicle,land,car,buggy,desert,rainforest |
| Deathstalker Scorpion muscle car <br/>`v017_car_vintagemuscle_rico` | vehicle,land,car,rico |

### [Digital deluxe content](https://store.steampowered.com/app/868422/Just_Cause_4_Digital_Deluxe_Content/)

| Name | Tags |
| ---- | ----------- |
| Black Hand stealth microjet <br/>`v403_plane_microjet_preorder_01` | vehicle,air,plane,preorder,armed |

### [Neon Racer pack](https://store.steampowered.com/app/868428/Just_Cause_4_Neon_Racer_Pack/)

| Name | Tags |
| ---- | ----------- |
| Neon Racer supercar <br/>`v024_car_ecosuper_preorder_01` | vehicle,land,car,civilian,sport,desert |

## DLC Vehicles

These vehicles are standalone DLCs and have to be purchased separately.

### [Toy vehicle pack](https://store.steampowered.com/app/1087120/Just_Cause_4_Toy_Vehicle_Pack/)

| Name | Tags |
| ---- | ----------- |
| El Tanquecito <br/>`v820_treaded_toytank_garage` | vehicle,land,tank,heat_easteregg |
| El Pajarito <br/>`v420_plane_toybomber_garage` | vehicle,air,plane,heat_easteregg |
| El Buquecito <br/>`v122_boat_toypatrol_garage` | vehicle,sea,boat,ship,garage,ocean,heat_easteregg |

### [Soaring Speed vehicle pack](https://store.steampowered.com/app/1087121/Just_Cause_4_Soaring_Speed_Vehicle_Pack/)

| Name | Tags |
| ---- | ----------- |
| Prisa Avispa C <br/>`v086_car_flyingcar_garage` | vehicle,land,garage |
| Coyle Rattler <br/>`v053_car_hotrod_garage` | vehicle,land,car,worldsim,garage |
| Coyle Rattler custom <br/>`v053_car_hotrod_ratrod` | vehicle,land,car,garage |

### [Adversary vehicle pack](https://store.steampowered.com/app/1087122/Just_Cause_4_Adversary_Vehicle_Pack/)

| Name | Tags |
| ---- | ----------- |
| Prospero Shade <br/>`v081_car_interceptor` | vehicle,land,car,military,garage |
| X700 Flycatcher <br/>`v422_plane_vtoljet_garage` | vehicle,air,plane,armed,ocean,desert,grassland |

### [Sea Dogs vehicle pack](https://store.steampowered.com/app/1087123/Just_Cause_4_Sea_Dogs_Vehicle_Pack/)

| Name | Tags |
| ---- | ----------- |
| SS Borracho <br/>`v080_car_galleonfloat_garage` | vehicle,land,truck,garage |
| Hellbender <br/>`v850_car_hovercraft_armored_garage` | vehicle,land,car,tank,garage |

### [Shark & Bark vehicle pack](https://store.steampowered.com/app/1087131/Just_Cause_4__Shark__Bark_Vehicle_Pack/)

| Name | Tags |
| ---- | ----------- |
| Thresher <br/>`v082_car_shark_garage` | vehicle,land,truck,garage |
| '84 Sheepdog <br/>`v083_car_dog_garage` | vehicle,land,truck,garage |

### [Brawler Mech](https://store.steampowered.com/app/1087130/Just_Cause_4_Brawler_Mech/)

| Name | Tags |
| ---- | ----------- |
| Brawler mech <br/>`v600_mech_loader_garage` | vehicle,land,plane,ocean,desert,grassland |

## Major DLC vehicles

These vehicles are part of major DLCs and have to be purchased either separately or all at once as part of the expansion pass.

### [Dare Devils of Destruction](https://store.steampowered.com/app/971760/Just_Cause_4_Dare_Devils_of_Destruction/)

#### Excorpión variations

| Name | Tags |
| ---- | ----------- |
| Reptile AAV <br/>`v012_car_apc_daredevil` | vehicle,land,daredevil |

#### Excorpión variations

| Name | Tags |
| ---- | ----------- |
| Excorpión (civilian) <br/>`v051_car_battlemuscle_level_0` | vehicle,land,car,daredevil,v051,worldsim |
| Excorpión Model B (rusty) <br/>`v051_car_battlemuscle_intro_level_1` | vehicle,land,daredevil,v051 |
| Excorpión Model B (shiny paintjob) <br/>`v051_car_battlemuscle_daredevil` | vehicle,land,daredevil,v051 |
| Excorpión Model A (rusty) <br/>`v051_car_battlemuscle_intro_level_2` | vehicle,land,daredevil,v051 |
| Excorpión Model S (rusty) <br/>`v051_car_battlemuscle_intro_level_3` | vehicle,land,daredevil,v051 |
| Excorpión Gale Force B <br/>`v051_car_battlemuscle_rampagerallyace_level_1` | vehicle,land,daredevil,v051 |
| Excorpión Gale Force A <br/>`v051_car_battlemuscle_rampagerallyace_level_2` | vehicle,land,daredevil,v051 |
| Excorpión Gale Force S <br/>`v051_car_battlemuscle_rampagerallyace_level_3` | vehicle,land,daredevil,v051 |
| Excorpión Scatterbane B <br/>`v051_car_battlemuscle_deathraceace_level_1` | vehicle,land,daredevil,v051 |
| Excorpión Scatterbane A <br/>`v051_car_battlemuscle_deathraceace_level_2` | vehicle,land,daredevil,v051 |
| Excorpión Scatterbane S <br/>`v051_car_battlemuscle_deathraceace_level_3` | vehicle,land,daredevil,v051 |
| Excorpión Hard Hornet B <br/>`v051_car_battlemuscle_survivalraceace_level_1` | vehicle,land,daredevil,v051 |
| Excorpión Hard Hornet A <br/>`v051_car_battlemuscle_survivalraceace_level_2` | vehicle,land,daredevil,v051 |
| Excorpión Hard Hornet S <br/>`v051_car_battlemuscle_survivalraceace_level_3` | vehicle,land,daredevil,v051 |
| Excorpión Slidestrike B <br/>`v051_car_battlemuscle_outro_level_1` | vehicle,land,daredevil,v051 |
| Excorpión Slidestrike A <br/>`v051_car_battlemuscle_outro_level_2` | vehicle,land,daredevil,v051 |
| Excorpión Slidestrike S <br/>`v051_car_battlemuscle_outro_level_3` | vehicle,land,daredevil,v051 |
| Excorpión Model U (unused) <br/>`v051_car_battlemuscle_rust01` | vehicle,land,daredevil,v051 |
| Excorpión Model U (fancy paintjob, unused) <br/>`v051_car_battlemuscle_stripe01` | vehicle,land,daredevil,v051 |
| Excorpión Model U (shiny paintjob, unused) <br/>`v051_car_battlemuscle_stripe02` | vehicle,land,daredevil,v051 |
| Excorpión Model U (tiger paintjob, unused) <br/>`v051_car_battlemuscle_tiger01` | vehicle,land,daredevil,v051 |
| El Torrente <br/>`v051_car_battlemuscle_allgold_level_3` | vehicle,land,daredevil,v051 |
| El Torrente (all weapons, unused) <br/>`v051_car_battlemuscle_metal01` | vehicle,land,daredevil,v051 |
| El Tigre <br/>`v051_car_battlemuscle_collectible_level_3` | vehicle,land,daredevil,v051 |

| Name | Tags |
| ---- | ----------- |
| Python offroader <br/>`v070_car_offroadtruckdlc1_level_0` | vehicle,land,daredevil,v070,team_mechanics |
| Python offroader B <br/>`v070_car_offroadtruckdlc1_level_1` | vehicle,land,daredevil,v070,team_mechanics |
| Python offroader A <br/>`v070_car_offroadtruckdlc1_level_2` | vehicle,land,daredevil,v070,team_mechanics |
| Python offroader S <br/>`v070_car_offroadtruckdlc1_level_3` | vehicle,land,daredevil,v070,team_mechanics |
| Huaso truck <br/>`v071_car_modernpickupdlc1_level_0` | vehicle,land,daredevil,v071,team_mechanics |
| Huaso truck b <br/>`v071_car_modernpickupdlc1_level_1` | vehicle,land,daredevil,v071,team_mechanics |
| Huaso truck A <br/>`v071_car_modernpickupdlc1_level_2` | vehicle,land,daredevil,v071,team_mechanics |
| Huaso truck S <br/>`v071_car_modernpickupdlc1_level_3` | vehicle,land,daredevil,v071,team_mechanics |
| Volcán SUV <br/>`v072_car_vintagesuvdlc1_level_0` | vehicle,land,daredevil,v072,team_convicts |
| Volcán SUV B <br/>`v072_car_vintagesuvdlc1_level_1` | vehicle,land,daredevil,v072,team_convicts |
| Volcán SUV A <br/>`v072_car_vintagesuvdlc1_level_2` | vehicle,land,daredevil,v072,team_convicts |
| Volcán SUV S <br/>`v072_car_vintagesuvdlc1_level_3` | vehicle,land,daredevil,v072,team_convicts |
| Sol Velocista <br/>`v073_car_luxurysportssedandlc1_level_0` | vehicle,land,daredevil,v073,team_racers |
| Sol Velocista-B <br/>`v073_car_luxurysportssedandlc1_level_1` | vehicle,land,daredevil,v073,team_racers |
| Sol Velocista-A <br/>`v073_car_luxurysportssedandlc1_level_2` | vehicle,land,daredevil,v073,team_racers |
| Sol Velocista-S <br/>`v073_car_luxurysportssedandlc1_level_3` | vehicle,land,daredevil,v073,team_racers |
| Verdeneon <br/>`v074_car_ecosuperdlc1_level_0` | vehicle,land,daredevil,v074,team_racers |
| Verdeneon B <br/>`v074_car_ecosuperdlc1_level_1` | vehicle,land,daredevil,v074,team_racers |
| Verdeneon A <br/>`v074_car_ecosuperdlc1_level_2` | vehicle,land,daredevil,v074,team_racers |
| Verdeneon S <br/>`v074_car_ecosuperdlc1_level_3` | vehicle,land,daredevil,v074,team_racers |
| Tormenta Super <br/>`v075_car_vintagesuperdlc1_level_0` | vehicle,land,daredevil,v075,team_convicts |
| Tormenta Super B <br/>`v075_car_vintagesuperdlc1_level_1` | vehicle,land,daredevil,v075,team_convicts |
| Tormenta Super A <br/>`v075_car_vintagesuperdlc1_level_2` | vehicle,land,daredevil,v075,team_convicts |
| Tormenta Super S <br/>`v075_car_vintagesuperdlc1_level_3` | vehicle,land,daredevil,v075,team_convicts |
| Rufián Buggy <br/>`v076_car_racingbuggydlc1_level_0` | vehicle,land,daredevil,v076,team_convicts |
| Rufián Buggy B <br/>`v076_car_racingbuggydlc1_level_1` | vehicle,land,daredevil,v076,team_convicts |
| Rufián Buggy A <br/>`v076_car_racingbuggydlc1_level_2` | vehicle,land,daredevil,v076,team_convicts |
| Rufián Buggy S <br/>`v076_car_racingbuggydlc1_level_3` | vehicle,land,daredevil,v076,team_convicts |
| Azor Stylex <br/>`v077_car_offroadracingsedandlc1_level_0` | vehicle,land,daredevil,v077,team_racers |
| Azor Stylex B <br/>`v077_car_offroadracingsedandlc1_level_1` | vehicle,land,daredevil,v077,team_racers |
| Azor Stylex A <br/>`v077_car_offroadracingsedandlc1_level_2` | vehicle,land,daredevil,v077,team_racers |
| Azor Stylex S <br/>`v077_car_offroadracingsedandlc1_level_3` | vehicle,land,daredevil,v077,team_racers |
| Overgust Monster <br/>`v078_car_monstertruckdlc1_level_0` | vehicle,land,daredevil,v078,team_mechanics |
| Overgust Monster B <br/>`v078_car_monstertruckdlc1_level_1` | vehicle,land,daredevil,v078,team_mechanics |
| Overgust Monster A <br/>`v078_car_monstertruckdlc1_level_2` | vehicle,land,daredevil,v078,team_mechanics |
| Overgust Monster S <br/>`v078_car_monstertruckdlc1_level_3` | vehicle,land,daredevil,v078,team_mechanics |
...
| Name | Tags |
| ---- | ----------- |
| AA gun tendril <br/>`dlc2_substrate_weapon_aa_gun_01` | dlc2_substrate_weapon_aa_gun_01 |
| Mortar tendril <br/>`dlc2_substrate_weapon_mortar_01` | dlc2_substrate_weapon_mortar_01 |
| Reptile AAV tendril <br/>`dlc2_substrate_weapon_apc_01` | dlc2_substrate_weapon_apc_01 |
| Falconer AA tank tendril <br/>`dlc2_substrate_weapon_aa_tank_01` | dlc2_substrate_weapon_aa_tank_01 |
| Warchief assault tank tendril <br/>`dlc2_substrate_weapon_modern_tank_01` | dlc2_substrate_weapon_modern_tank_01 |
| Longbow cannon truck tendril <br/>`dlc2_substrate_weapon_cannon_truck_01` | dlc2_substrate_weapon_cannon_truck_01 |
| AA gun tendril <br/>`dlc2_substrate_weapon_heli_light_01` | dlc2_substrate_weapon_heli_light_01 |

#### Tendrils (bossfight versions)

| Name | Tags |
| ---- | ----------- |
| AA gun tendril <br/>`dlc2_substrate_weapon_aa_gun_01_outro` | dlc2_substrate_weapon_aa_gun_01_outro |
| Mortar tendril <br/>`dlc2_substrate_weapon_mortar_01_outro` | dlc2_substrate_weapon_mortar_01_outro |
| Reptile AAV tendril <br/>`dlc2_substrate_weapon_apc_01_outro` | dlc2_substrate_weapon_apc_01_outro |
| Falconer AA tank tendril <br/>`dlc2_substrate_weapon_aa_tank_01_outro` | dlc2_substrate_weapon_aa_tank_01_outro |
| Warchief assault tank tendril <br/>`dlc2_substrate_weapon_modern_tank_01_outro` | dlc2_substrate_weapon_modern_tank_01_outro |
| Longbow cannon truck tendril <br/>`dlc2_substrate_weapon_cannon_truck_01_outro` | dlc2_substrate_weapon_cannon_truck_01_outro |

### [Danger Rising](https://store.steampowered.com/app/972350/Just_Cause_4_Danger_Rising/)

| Name | Tags |
| ---- | ----------- |
| A5 Coyote assault chpper <br/>`v221_helicopter_agencyspy_agency` | vehicle,air,helicopter,agency,armed |
| Daggershark jetboat (unused) <br/>`v123_boat_agencyspy_agency` | vehicle,sea,boat,agency,armed |
| C3 Canvasback hovercraft <br/>`v851_car_hovercraft_agency` | vehicle,sea,boat,agency,armed,hovercraft,amphibious |
| Agency drone (Agency) <br/>`v270_helicopter_agencydrone_agency` | vehicle,air,drone,agency,armed,agent_grapple |
| Agency drone (AOC) <br/>`v270_helicopter_agencydrone_rebel` | vehicle,air,drone,agency_rebel,armed,rebel |
| Huntsman SAM launcher <br/>`v908_trailer_agencysmallmobileweapon_agency` | vehicle,land,trailer,agency,sam,armed |

#### Mission vehicles
| Name | Tags |
| ---- | ----------- |
| Pugilista SUV <br/>`v002_car_vintagesuv_rebel_mission_special_dlc3_intro` | vehicle,mission_special |
| C3 Canvasback hovercraft <br/>`v851_car_hovercraft_agency_mission_special_dlc3_outro` | vehicle,amphibious,mission |
